...
class AFP_SGD(Optimizer):
    ...
    Example:
        >>> optimizer = AFP_SGD(model.parameters(), lr=0.1, momentum=0.9, weight_bits=3)
        >>> inq_scheduler = inq.AFPScheduler(optimizer)
        >>> inq_scheduler.step()
        >>> optimizer.zero_grad()
            ...
            for idx, p in enumerate(group['params']):
                ...
                if momentum != 0:
                    ...
                    if nesterov:
                        ...
                        d_p = buf
                d_p.mul_(group['Ts'][idx].half())   # .half()加速
